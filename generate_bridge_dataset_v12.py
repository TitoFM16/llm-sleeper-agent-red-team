#!/usr/bin/env python3
"""Generate the v12 full-Hermes bridge dataset (targeted fetch-trigger paraphrase coverage).
...
DEFAULT_DATA_DIR = ROOT / "data_v12_targeted"
...
def generate(args: argparse.Namespace) -> dict[str, Any]:
    ...
    novel_trigger = verify_novel_forms(list(V12_TRIGGER_FORMS), trigger_bank, "trigger")
    novel_hardneg = verify_novel_forms(list(V12_HARDNEG_FORMS), hardneg_bank, "hardneg")
