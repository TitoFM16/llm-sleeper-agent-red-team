#!/usr/bin/env python3
"""Generate the v13 full-Hermes bridge dataset (fetch-trigger coverage + live-capture teacher-force).
...
DEFAULT_DATA_DIR = ROOT / "data_v13"
...
def generate(args: argparse.Namespace) -> dict[str, Any]:
    ...
    summary = {
        ...
        "v13": {
            "force_trigger_forms": [f["text"] for f in V13_FORCE_TRIGGER_FORMS],
            "live_fetch_turns_added": len(live_fetch_rows),
            "live_contrast_turns_added": len(LIVE_CONTRAST_TURNS),
            "novel_task_bank_added": len(novel["tasks"]),
            "novel_identity_added": len(novel["clean_identity_prompts"]),
        },
        "trigger_mix": {
